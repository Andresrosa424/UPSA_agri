...
```{r}
LISA <- read.csv("C:/Users/Andres/OneDrive - University of Saskatchewan/02_Analysis/Chapter1/eBird trend data/vector_pixels/Moran/LISA_results.csv")
LISA <- LISA[,-c(1:6, 8:19)]
