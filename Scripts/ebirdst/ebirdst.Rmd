...
# Periphery 
```{r}
utrends_buff_5070 <- st_transform(utrends_buff, crs = 5070)

ensemble_union <- st_union(utrends_buff_5070)

# Compute the centroid of the merged geometry
ensemble_centroid <- st_centroid(ensemble_union)

# Print the centroid
print(ensemble_centroid)
