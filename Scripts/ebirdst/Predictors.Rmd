...
plot_ly(
  ...
  dimensions = list(
    ...
    list(label = "Grassland LPI", values = df_normalized$lpi_c11_Grassland),
    list(label = "Forage LPI", values = df_normalized$lpi_c09_Forage),
    list(label = "SHDI", values = df_normalized$shdi_cNA_NA),
    list(label = "AI", values = df_normalized$ai_cNA_NA),
    list(label = "Cohesion", values = df_normalized$cohesion_cNA_NA)
  )
) %>%
  layout(
